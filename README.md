...
* **Adaptive Strategy**
    * **Low Penalty (beta <= 1):** Uses a Genetic Algorithm with **Large Neighborhood Search (LNS)** (only if beta == 1.0 and IS_HUGE) and **2-opt** local search to optimize geometry.
